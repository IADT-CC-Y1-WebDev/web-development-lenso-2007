...
let publishersInput = document.getElementsByName('publishers');
let descriptionInput = document.getElementById('description');
let formatidInput = document.getElementsByName('format_ids[]');
...
let publishersError = document.getElementById('publishers_error');
let description_error = document.getElementById('description_error');
let formatidError = document.getElementsByName('format_ids_error[]');
...
function onSubmitForm(evt) {
    ...
    let descMin = descriptionInput.dataset.minlength || 3;;
