...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="width-12">
                <form id="format_form" action="format_store.php" method="POST" enctype="multipart/form-data" novalidate>
                    <h1>Create Format</h1>
                    ...
                    <div class="input">
                        <button class="button" id="submit_btn" type="submit">Store Format</button>
        ...
        <script src="js/format_validation.js"></script>
    </body>
</html>
<?php
clearFormData();
